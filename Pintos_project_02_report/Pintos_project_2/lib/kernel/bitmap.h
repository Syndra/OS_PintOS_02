...
/* (ADD) For free pages allocated on buddy system. */
void bitmap_set_multiple_buddy (struct bitmap *b, size_t start, size_t cnt, bool value);
...
/* (ADD) Original bitmap_scan() is on strategy of First fit, others in name. */
size_t bitmap_scan (const struct bitmap *, size_t start, size_t cnt, bool);
size_t bitmap_scan_nf(struct bitmap *b, size_t start, size_t cnt, bool);
size_t bitmap_scan_bf(const struct bitmap *b, size_t start, size_t cnt, bool);
size_t bitmap_scan_buddy(const struct bitmap *b, size_t start, size_t cnt, bool);
/* (ADD) Original bitmap_scan_and_flip() is on strategy of First fit, others in name.  */
size_t bitmap_scan_and_flip (struct bitmap *, size_t start, size_t cnt, bool);
size_t bitmap_scan_and_flip_nf (struct bitmap *, size_t start, size_t cnt, bool);
size_t bitmap_scan_and_flip_bf (struct bitmap *, size_t start, size_t cnt, bool);
